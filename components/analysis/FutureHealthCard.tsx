...
export default function FutureHealthCard({
  items,
  recommendations,
}: FutureHealthProps) {
  return (
    <View style={styles.futureCard}>
      <View style={styles.statsHeader}>
        ...
        />
        <Text style={styles.statsTitle}>Future Health Predictions</Text>
      </View>
      ...
      {items.map((item, idx) => (
        <View key={idx} style={styles.futureRow}>
          ...
          <View
            style={[
              styles.futureBadge,
              item.statusType === "warning" && styles.futureBadgeWarning,
            ]}
          >
            <Text
              style={[
                styles.futureBadgeText,
                item.statusType === "warning" && styles.futureBadgeTextWarning,
              ]}
            >
              {item.status}
            </Text>

...
const FamilyViewContext = createContext<FamilyViewContextType | undefined>(undefined);
...
export function useFamilyView() {
  ...
  if (!ctx) throw new Error("useFamilyView must be used within FamilyViewProvider");
  return ctx;
}

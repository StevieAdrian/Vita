        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.scrollWrapper}>
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: NAV_ITEMS + insets.bottom + 30, }}>
                    ...
                    <InputField label="Name" placeholder={"John Doe"} onChangeText={(text) => handleChange("name", text)} required/>
                    ...
                    <View>
                        ...
                        <TouchableOpacity
                            ...
                            activeOpacity={0.7}
                        >
                            <Text style={[ styles.dropdownText, !form.relation && styles.placeholderText ]} >
                    ...
                    <InputField label="Account Username" placeholder={"John Doe"} 
                        onChangeText={(text) => {
                    ...
                    <Text style={styles.reqNotes}>Request Notes 
                    ...
                    <PrimaryButtonColorForm text={loading ? "Sending..." : "Send Request"} active={!!form.username && !!form.relation && !!form.name} onPress={handleSend}/>

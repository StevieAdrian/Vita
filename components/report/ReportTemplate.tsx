...
export interface ReportData {
  ...
  bloodPressure: {
    ...
    high: string;
    low: string;
    systolicHighDate: string;
    systolicLowDate: string;
    diastolicHighDate: string;
    diastolicLowDate: string;
  };
  heartRate: {
    avg: number;
    high: number;
...
export const generateReportHTML = ({
  ...
  return `
                    ...
                    <div class="vital-grid">
                        <div class="vital-box">
                            ...
                            <div class="vital-item">
                                ...
                                } mg/dL<span class="vital-date">${
    data.bloodSugar.highDate
  }</span></span>
                            </div>
                            <div class="vital-item">
    ...
    data.bloodSugar.lowDate
                        ...
                        <div class="vital-box">
                            ...
                            <div class="vital-item">
                                ...
                                <span class="vital-value">${
                                  data.heartRate.high
                                } bpm<span class="vital-date">${
    data.heartRate.highDate
  }</span></span>
                            </div>
                            <div class="vital-item">
                                <span class="vital-label">Lowest</span>
    ...
    data.heartRate.lowDate
                        ...
                        <div class="vital-box">
                            ...
                            <div class="vital-item">
                                ...
                                <span class="vital-value">160 mmHg<span class="vital-date">${
                                  data.bloodPressure.systolicHighDate
                                }</span></span>
                            </div>
                            <div class="vital-item">
                                <span class="vital-label">Lowest Systolic</span>
                                <span class="vital-value">50 mmHg<span class="vital-date">${
                                  data.bloodPressure.systolicLowDate
                                }</span></span>
                            </div>
                            <div class="vital-item">
                                <span class="vital-label">Highest Diastolic</span>
                                <span class="vital-value">160 mmHg<span class="vital-date">${
                                  data.bloodPressure.diastolicHighDate
                                }</span></span>
                            </div>
                            <div class="vital-item">
                                <span class="vital-label">Lowest Diastolic</span>
                                <span class="vital-value">50 mmHg<span class="vital-date">${
                                  data.bloodPressure.diastolicLowDate
                                }</span></span>
                            </div>
                        </div>
                        ...
                        <div class="vital-box">
                            ...
                            <div class="vital-item">
                                ...
                                <span class="vital-value">${
                                  data.weight.high
                                }kg<span class="vital-date">${
    data.weight.highDate
  }</span></span>
                            </div>
                            <div class="vital-item">
                                <span class="vital-label">Lowest</span>
    ...
    data.weight.lowDate
                    ...
                    <div class="note-text">Data Recorded Last Update ${
                      data.update
                    }</div>
                </div>

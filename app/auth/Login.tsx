        ...
        <View style={styles.container}>
            ...
            <View style={styles.boxContainer}>
                ...
                <View style={styles.innerContainer}>
                    <TextInput placeholder="johndoe@gmail.com" placeholderTextColor="#999" style={styles.input} />
                </View>
                ...
                <View style={styles.innerContainer}>
                    <TextInput placeholder="********" secureTextEntry placeholderTextColor="#999" style={styles.input}
                    />
                </View>
